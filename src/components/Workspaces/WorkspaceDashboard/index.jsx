    ...
    <div className=" p-6 bg-neutral-900 min-h-screen">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-white mb-2">Marketing Team Workspace</h1>
            <p className="text-neutral-400">Monitor your team's performance and activity</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-neutral-800 rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-semibold text-white mb-1">Team Activity</h2>
              <p className="text-sm text-neutral-400">Messages per day</p>
            </div>
