            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center">
                    <div className="flex items-center">
                        {!isMobileMenuOpen && (
                            <button
                                className={`lg:hidden top-4 left-4 z-50 p-2 rounded-md text-neutral-300 hover:bg-neutral-700 transition-opacity duration-300 `}
                ...
                <div className="flex items-center space-x-4 flex-1 justify-end">
                    <div className="relative max-w-xs w-full sm:max-w-md">
                        ...
                        />
                        <Search className="w-5 h-5 absolute right-3 top-2.5 text-neutral-400" />
                    </div>
                </div>
            </div>
            {/* Modals */}
