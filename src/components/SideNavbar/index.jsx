...
import { ChevronDown, Hash, MessageSquare, Search, Workflow, X } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 px-4 py-6 space-y-2 overflow-y-auto scrollbar-hide">
            ...
            <NavigationItem icon={Hash} label="Channels">
              ...
              <NavigationLink href="#"># Announcements</NavigationLink>
            </NavigationItem>

            {/* Direct Messages */}
            <NavigationItem icon={MessageSquare} label="Direct Messages">
